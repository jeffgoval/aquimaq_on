        ...
        <div className="bg-gray-50 min-h-screen pb-12">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="flex items-center gap-3 mb-8">
                    <Heart className="text-agro-700 fill-agro-600" size={32} />
                ...
                {loading ? (
                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
                        ...
                        <h2 className="text-xl font-semibold text-gray-900 mb-2">Sua lista de desejos estÃ¡ vazia</h2>
                        <p className="text-gray-500 mb-6">
                            Salve os produtos que vocÃª mais gostou para ver depois.
                        </p>
                        ...
                        {wishlistProducts.length > 0 ? (
                            ...
                            <div className="col-span-full text-center py-10 bg-white rounded-lg border border-gray-200">
                                <p className="text-gray-500">
                                    NÃ£o foi possÃ­vel carregar os detalhes dos produtos favoritos. Tente novamente mais tarde.
                                </p>
                            </div>
                        )}
                    </div>

...
/** Processa PDF (manual/bula) para RAG: ingestão e vetorização. Retorna número de chunks. */
export const processPdfForRag = async (
  productId: string,
  pdfUrl: string
  ...
  const { data, error } = await supabase.functions.invoke('process-pdf', {
    body: { product_id: productId, pdf_url: pdfUrl },
